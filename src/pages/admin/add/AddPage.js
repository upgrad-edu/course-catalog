...
const AddPage = () => {
  ...
  return (
    <div className={cssClasses.addPage}>
      {/* Header */}
      <MuiPrimarySearchAppBar isLogoClickable={true} isProfileVisible={true} />

      {/* Main Content */}
      <main className={cssClasses.addPageContent}>
        <Typography
          variant="inherit"
          component="h3"
          color="secondary"
          className={cssClasses.addPageHeading}
        >
          Add Course
        </Typography>
        <form
        ...
        >
          ...
          <div className={classes.controlsGroup}>
            <FormControl variant="filled">
              ...
              {errors.priceInRupees && (
                <div className={cssClasses.error}>{errors.priceInRupees}</div>
              )}
            </FormControl>
            <FormControl variant="filled">
          ...
          <Button
            ...
            color="secondary"
            size="large"
            className={`${cssClasses.addCourseButton} ${cssClasses.formButton}`}
